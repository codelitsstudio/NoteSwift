...
export const listUnlockCodes = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const getUnlockCode = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const { id } = req.params;
