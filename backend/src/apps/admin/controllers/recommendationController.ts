 ...
 */
export const analyzeCourse = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    await connectDB();
    ...
    if (mode === 'auto') {
      ...
      const { analyzeCourseForRecommendations } = await import('../ai/flows/course-recommendations');
      const analysisInput = {
        title: course.title,
 ...
 */
export const getRecommendationStats = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    await connectDB();
 ...
 */
export const getCourseChanges = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
 ...
 */
export const analyzeAllCourses = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    await connectDB();
