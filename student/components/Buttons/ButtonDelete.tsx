...
export default function ButtonSecondary({
  ...
  className="self-center w-3/4 border border-customRed py-4 rounded-full items-center mb-[50px] mt-2"
>
  {loading ? (
    <ActivityIndicator size="small" color="#007AFF" />
  ) : (
    <Text className="text-customRed text-xl font-semibold">{title}</Text>
  )}
</TouchableOpacity>
