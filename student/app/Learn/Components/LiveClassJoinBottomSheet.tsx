    ...
    >
      ...
      >
        ...
        <View className="mx-5 mb-5">
          <View className="bg-gray-900 rounded-xl overflow-hidden" style={{ aspectRatio: 16/9 }}>
            <View className="flex-1 items-center justify-center">
              {videoEnabled ? (
                <View className="items-center">
                  <View className="w-14 h-14 bg-blue-500 rounded-full items-center justify-center mb-2">
                ...
                <View className="items-center">
                  <MaterialIcons name="videocam-off" size={28} color="#6B7280" />
        ...
        <View className="mx-5 mb-6">
          <Text className="text-sm font-semibold text-gray-900 mb-3">Audio & Video</Text>
          ...
          {/* Video Toggle */}
          <View className="bg-gray-50 rounded-xl p-3.5 flex-row items-center justify-between">
            <View className="flex-row items-center flex-1">
              <View className={`w-9 h-9 rounded-full items-center justify-center mr-3 ${
